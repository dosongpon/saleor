...
class ScbQrGatewayPlugin(BasePlugin):
    PLUGIN_ID = "do.payments.scbqr"
    ...
    CONFIG_STRUCTURE = {
        "Public API key": {
            ...
            "help_text": "Provide SCB public API key",
            "label": "Public API key",
        },
        "Secret API key": {
            "type": ConfigurationTypeField.SECRET,
            "help_text": "Provide SCB secret API key",
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.config = GatewayConfig(
            ...
            connection_params={
                ...
                "merchant_id": configuration["Merchant"],
                "terminal_id": configuration["Terminal"],
                "biller_id": configuration["Biller"],
            },
